...
export function NavigationModern() {
  ...
  return (
    <motion.nav
      ...
      style={{
        ...
        borderBottom: isScrolled ? '1px solid rgba(45, 106, 79, 0.2)' : 'none',
      }}
    >
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            >
              hupi
              <span style={{ color: '#F77F00' }}>food</span>
            </span>
          </motion.a>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-6 py-2.5 rounded-full relative overflow-hidden group font-semibold text-sm flex items-center gap-2 no-underline"
              style={{
                fontFamily: "'Inter', sans-serif",
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-white/20 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300 rounded-full"
              />
            </motion.a>
          </div>
          ...
          >
            ...
            >
              {isMobileMenuOpen ? (
                <X size={28} color="#F77F00" strokeWidth={2} />
              ) : (
                <Menu size={28} color="#F77F00" strokeWidth={2} />
              )}
            </motion.div>
          </button>
        </div>
